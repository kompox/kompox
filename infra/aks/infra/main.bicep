...
output AZURE_AKS_CLUSTER_PRINCIPAL_ID string = aks.outputs.clusterPrincipalId
output AZURE_AKS_KUBELET_PRINCIPAL_ID string = aks.outputs.kubeletPrincipalId
